...
<template>
  <div class="mobile-menu-searh">
    <!-- Иконка для открытия модального окна с поиском -->
    <button
            @click="openSearchBar"
            class="btn-mobile">
      <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
           width="24.000000" height="24.000000" fill="none">
        <rect id="icon / search" width="24.000000" height="24.000000" x="0.000000" y="0.000000" fill="rgb(255,255,255)"
              fill-opacity="0" />
        <path id="Vector"
