...
import { formatRating, getRatingColor, getTimeFormat } from "@/utils/movieUtils.ts";
...
// === EVENTS ===
/**
 * Передаём ID фильма в родительский компонент, чтобы родитель знал, какой фильм открыть
 */
